...
# 아이디 게임명 접속시간 디비에 업데이트를
# 게임명aa 아이디 haiteam 게임상태load
...
class Bird(pygame.sprite.Sprite): # pygame의 sprite 클래스 이용 (update & draw)
    def __init__(self, x, y):
        ...
        for num in range(1, 4):
            img = pygame.image.load(f'C:/Users/Owner/Desktop/team7Project/MyFirstProjectGame/img/bird{num}.png')
